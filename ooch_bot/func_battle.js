...
battle_calc_exp: function(enemy_level, enemy_evo_stage, bonus_multiplier = 1) {
    ...
    return Math.round(((bonus_multiplier * (1.025 ** enemy_level) * (2 ** enemy_evo_stage) * 8 * enemy_level * (_.random(90, 100)/100)) + 20) * exp_multiplier + (Math.max(enemy_level - 20, 0) * 100));
},
