...
export async function execute(interaction, client) {
    ...
    create_tile(`c_051`, Tile.Npc); // Main Character
    ...
    create_item({
        id: 46, name: 'Odd Bulb', emote: get_emote_string('item_odd_bulb'),
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_000',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_051',
        description: 'Change your appearance to match this sprite.',
        description_short: 'A cosmetic outfit.'
    });
    create_item({
        id: 50, name: 'Skin: Scout', emote: get_emote_string('c_001'),
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_001',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_002',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_003',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_004',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_005',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_006',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_007',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_009',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_010',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_011',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_014',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_015',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_016',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_018',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_027',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_028',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_039',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_052',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_053',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_055',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_056',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_057',
        description: 'Change your appearance to match this sprite. Made for a playtester.',
        description_short: 'A cosmetic outfit.'
    });
    create_item({
        id: 72, name: 'Skin: Tamagoochi™ Girl 👌', emote: get_emote_string('c_058'),
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_058',
        description: 'Change your appearance to match this sprite. Made for a playtester.',
        description_short: 'A cosmetic outfit.'
    });
    create_item({
        id: 73, name: 'Skin: Jeffdev', emote: get_emote_string('c_059'),
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_059',
        description: 'Change your appearance to match this sprite. Made for one of the devs.',
        description_short: 'A cosmetic outfit.'
    });
    create_item({
        id: 74, name: 'Skin: Terarabe', emote: get_emote_string('c_060'),
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_060',
        description: 'Change your appearance to match this sprite. Made for a playtester.',
        description_short: 'A cosmetic outfit.'
    });
    create_item({
        id: 75, name: 'Skin: JEKYLL POWER STANCE', emote: get_emote_string('c_061'),
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_061',
        description: 'Change your appearance to match this sprite. Made for a playtester.',
        description_short: 'A cosmetic outfit.'
    });
    create_item({
        id: 76, name: 'Skin: Neo', emote: get_emote_string('c_062'),
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_062',
    ...
    create_item({
        ...
        category: 'other_inv', type: 'skin', price: -1, potency: 'c_020',
    ...
    for (let obj of tile_data.values()) {
    ...
    readFile("./global_events.json", function (err, data) {
        ...
        for (let event of Object.entries(events)) {
            ...
            */
            events_data.set(event[0], event[1]);
        }
    });
