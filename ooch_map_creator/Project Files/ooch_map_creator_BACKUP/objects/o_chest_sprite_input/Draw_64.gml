var dw = ((array_length(chest_sprites)-1) mod 10)*tile_size+x+tile_size;
var dh = ((array_length(chest_sprites)-1) div 10)*tile_size+y+tile_size;

draw_set_alpha(.8);
draw_rectangle_color(x-tile_size*5,y,dw,dh,c_black,c_black,c_black,c_black,false);
draw_set_alpha(1);

for(var i = 0; i < array_length(chest_sprites); i++){
	var entry = chest_sprites[i];
