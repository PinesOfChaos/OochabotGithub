var dw = ((array_length(trainer_sprites)-1) mod 10)*tile_size+x+tile_size;
var dh = ((array_length(trainer_sprites)-1) div 10)*tile_size+y+tile_size;
